...
public class PrincessesAndMonstersVis {
    ...
    void countEverybody() {
        ...
        for (int i : pInd) princesses[state[i].r][state[i].c].add(i);
        for (int i : mInd) monsters[state[i].r][state[i].c].add(i);
        for (int i : kInd) knights[state[i].r][state[i].c].add(i);
    }
    // ---------------------------------------------------
...
// ------------- visualization part ----------------------
    ...
    public static void main(String[] args) {
        ...
        new PrincessesAndMonstersVis(seed);
    }
    // ---------------------------------------------------
